...
namespace Kangou.Core.Helpers
{
	...
	{
		public const string CONFIRM_MESSAGE_IOS = "Una vez que confirmes tu orden, buscaremos al Kangou más cercano para llevarte lo que deseas. \n\nEl cargo a la tarjeta o el pago en efectivo se realizará hasta que tu Kangou entregue lo pedido:\n\n$50.00 MXN del envío más la compra con un cargo del 5%";
