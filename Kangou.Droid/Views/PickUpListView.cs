...
namespace Kangou.Droid.Views
{
    ...
    [Activity(Label = "¿Dónde recolectar?")]
    public class PickUpListView : MvxFragmentActivity
    {
		...
		protected override void OnCreate(Bundle bundle)
		{
			...
			SetContentView(Resource.Layout.PickUpListView);
		...
		public override bool OnContextItemSelected(IMenuItem item)
		{
			...
			if (item.ItemId.Equals(DELETE_ITEM))
			{
				...
				var textView = itemListView.FindViewById<TextView> (Resource.Id.id_pickupdata);

				var idPIckUpDataSelected = Convert.ToInt32(textView.Text);

				var viewModel = (PickUpListViewModel)ViewModel;
				viewModel.DeleteData(idPIckUpDataSelected);
			}
