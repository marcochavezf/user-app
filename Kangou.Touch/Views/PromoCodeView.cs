...
namespace Kangou.Touch.Views
{
	...
	public class PromoCodeView : MvxViewController
	{
		public override void ViewDidLoad()
		{
			...
			//Items
			var itemsLabel = new UILabel(new CGRect(MARGIN_SUBVIEWS-7.5f, pY, WIDTH-MARGIN_SUBVIEWS*2, 20));
			...
			itemsButton.Frame = new CGRect(MARGIN_SUBVIEWS, pY, WIDTH-MARGIN_SUBVIEWS*2, HEIGHT_BUTTON);
			...
			//Drop Off
			var dropOffLabel = new UILabel(new CGRect(MARGIN_SUBVIEWS-7.5f, pY, WIDTH-MARGIN_SUBVIEWS*2, 20));
			...
			dropOffButton.Frame = new CGRect(MARGIN_SUBVIEWS, pY, WIDTH-MARGIN_SUBVIEWS*2, HEIGHT_BUTTON);
			...
			//Payment Method
			var paymentMethodLabel = new UILabel(new CGRect(MARGIN_SUBVIEWS-7.5f, pY, WIDTH-MARGIN_SUBVIEWS*2, 20));
			...
			paymentMethodButton.Frame = new CGRect(MARGIN_SUBVIEWS, pY, WIDTH-MARGIN_SUBVIEWS*2, HEIGHT_BUTTON);
			...
			pedirUnKangouButton.Frame = new CGRect(MARGIN_SUBVIEWS, pY, WIDTH-MARGIN_SUBVIEWS*2, HEIGHT_BUTTON);
